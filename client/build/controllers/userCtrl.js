...
const loginController = async(req,res) => {
    try {
        ...
        console.log(error)
        res.salt(500).send({message: `Error in login CTRL ${error.message}`})
...
const getAllNotificationController = async (req, res) => {
    try {
        ...
        // Push all unread notifications to seen notifications
        seennotification.push(...notification);
        // Clear the unread notifications
        user.notification = [];
        // Update the seen notifications with the combined list
...
const getAllDoctorsController = async(req,res) => {
    ...
    const bookAppointmentController = async(req,res) => {
        try {
            ...
            req.body.doctorInfo.status = "pending"
    ...
    const userAppointmentController = async(req,res) => {
        try {
            ...
            res.status(200).send({
                success:true,
                message: "Users Appointments Fetch Suucessfully",
                data: appointments, 
            })
            ...
            res.status(500).send({
                success:false,
                error,
                message:'Error in user Apoointment'
            })
